...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("FirstCommitment")));
bytes32 constant FirstCommitmentTableId = _tableId;

library FirstCommitment {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("FirstCommitment", _fieldNames);
  }
