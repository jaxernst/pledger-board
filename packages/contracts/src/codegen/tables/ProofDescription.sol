...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ProofDescription")));
bytes32 constant ProofDescriptionTableId = _tableId;

library ProofDescription {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ProofDescription", _fieldNames);
  }
