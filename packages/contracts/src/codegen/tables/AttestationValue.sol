...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AttestationValue")));
bytes32 constant AttestationValueTableId = _tableId;

library AttestationValue {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AttestationValue", _fieldNames);
  }
