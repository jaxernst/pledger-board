...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AttestationPerio")));
bytes32 constant AttestationPeriodTableId = _tableId;

library AttestationPeriod {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AttestationPeriod", _fieldNames);
  }
